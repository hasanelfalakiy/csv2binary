...
object ConvertCsvToKotlin {
    ...
    fun convertVsop87dCsvToKotlinArray(resourcePath: String, outputKtPath: String) {
        ...
        // get name file without extension, replace dash symbol with underscore
        val objectName = resourcePath.substringAfterLast("/").substringBeforeLast(".").replace("-", "_")

        // change name object to camelCase for variable name
        val variableName = objectName.split("_").joinToString("_") {
